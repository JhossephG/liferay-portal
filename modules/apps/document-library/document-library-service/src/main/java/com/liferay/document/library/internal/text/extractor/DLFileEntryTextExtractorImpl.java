...
package com.liferay.document.library.internal.text.extractor;
...
import com.liferay.document.library.text.extractor.DLFileEntryTextExtractor;
...
@Component(
	...
	service = DLFileEntryTextExtractor.class
)
public class DLFileEntryTextExtractorImpl implements DLFileEntryTextExtractor {
	...
	public String extractText(
		...
		try {
			return _extractText(dlFileEntry, dlFileVersion);
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DLFileEntryTextExtractorImpl.class);
