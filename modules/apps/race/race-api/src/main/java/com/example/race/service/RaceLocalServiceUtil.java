 ...
 * <code>com.example.race.service.impl.RaceLocalServiceImpl</code> and
...
public class RaceLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.example.race.service.impl.RaceLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Race addRace(Race race) {
	 ...
	 * @return the new race
	 */
	public static Race createRace(long raceId) {
	 ...
	 */
	public static Race deleteRace(long raceId) throws PortalException {
	 ...
	 * @return the race that was removed
	 */
	public static Race deleteRace(Race race) {
	...
	public static Race fetchRace(long raceId) {
	 ...
	 */
	public static Race fetchRaceByUuidAndGroupId(String uuid, long groupId) {
		return getService().fetchRaceByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 * @throws PortalException if a race with the primary key could not be found
	 */
	public static Race getRace(long raceId) throws PortalException {
	 ...
	 */
	public static Race getRaceByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {

		return getService().getRaceByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<Race> getRaces(int start, int end) {
	 ...
	 */
	public static List<Race> getRacesByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getRacesByUuidAndCompanyId(uuid, companyId);
	}
	...
	public static List<Race> getRacesByUuidAndCompanyId(
		...
		return getService().getRacesByUuidAndCompanyId(
	 ...
	 */
	public static Race updateRace(Race race) {
	...
	private static final Snapshot<RaceLocalService> _serviceSnapshot =
		new Snapshot<>(RaceLocalServiceUtil.class, RaceLocalService.class);
