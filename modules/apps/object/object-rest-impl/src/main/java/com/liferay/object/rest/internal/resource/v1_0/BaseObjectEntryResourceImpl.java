...
public abstract class BaseObjectEntryResourceImpl
	...
	@javax.ws.rs.PATCH
	@javax.ws.rs.Path("/expire/{objectEntryId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public ObjectEntry patchExpireObjectEntry(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("objectEntryId")
			Long objectEntryId)
	...
	@javax.ws.rs.Path("/{objectEntryId}/by-version/{version}/copy")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@javax.ws.rs.Path("/{objectEntryId}/by-version/{version}/expire")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
