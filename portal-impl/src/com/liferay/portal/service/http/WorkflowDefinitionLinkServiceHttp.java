...
public class WorkflowDefinitionLinkServiceHttp {
	...
	public static java.util.List
		...
		try {
			MethodKey methodKey = new MethodKey(
				...
				"getWorkflowDefinitionLinks",
				_getWorkflowDefinitionLinksParameterTypes0);
	...
	public static com.liferay.portal.kernel.model.WorkflowDefinitionLink
		...
		try {
			MethodKey methodKey = new MethodKey(
				WorkflowDefinitionLinkServiceUtil.class,
				"addWorkflowDefinitionLink",
				_addWorkflowDefinitionLinkParameterTypes1);
	...
	private static final Class<?>[] _getWorkflowDefinitionLinksParameterTypes0 =
		new Class[] {long.class, String.class, int.class};
	private static final Class<?>[] _addWorkflowDefinitionLinkParameterTypes1 =
		new Class[] {
